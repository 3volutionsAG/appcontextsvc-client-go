...
type TenantServiceClient interface {
	ListTenants(ctx context.Context, in *base.ListRequest, opts ...grpc.CallOption) (*ListTenantsResponse, error)
...
type TenantServiceServer interface {
	ListTenants(context.Context, *base.ListRequest) (*ListTenantsResponse, error)
...
func (UnimplementedTenantServiceServer) ListTenants(context.Context, *base.ListRequest) (*ListTenantsResponse, error) {
