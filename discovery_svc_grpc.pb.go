...
func (c *discoveryServiceClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedDiscoveryServiceServer) Register(context.Context, *RegisterRequest) (*emptypb.Empty, error) {
